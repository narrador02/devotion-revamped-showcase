...
export default function ProposalFooter({ proposal, dateRange, setDateRange, showBranding, brandingPrice, showFlightCase, flightCasePrice, selectedSimulator }: ProposalFooterProps) {
